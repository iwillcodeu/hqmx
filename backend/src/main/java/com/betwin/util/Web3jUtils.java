...
public class Web3jUtils {
     ...
     */
    public static BigDecimal getBalanceEther(Web3j web3j, String address)
    ...
    /**
     * Transfers the specified amount of Wei from the coinbase to the specified
     * account. The method waits for the transfer to complete using method
     * {@link waitForReceipt}.
     */
    public static TransactionReceipt transferFromCoinbaseAndWait(Web3j web3j, String to, BigInteger amountWei)
        ...
        Transaction transaction = Transaction.createEtherTransaction(coinbase, nonce, Web3jConstants.GAS_PRICE,
                gasLimit, to, amountWei);
     ...
     * Makes 40 attempts (waiting 1 sec. inbetween attempts) to get the receipt
     ...
     * Includes some preprocessing: removing '//' comments and \s+ are replaced by '
     * ' globally.
     */
